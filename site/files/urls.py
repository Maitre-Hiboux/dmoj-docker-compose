...
# Add 'dmoj' to all register_patterns
register_patterns = [url(r'^dmoj/', include(register_patterns2))]
...
# Add 'dmoj' to all urlpatterns
urlpatterns = [url(r'^dmoj/', include(urlpatterns2))]
